...
5. Open source generator checkpoint with 300000 steps, 500000 steps, 800000 steps, and val_rass values of 0.35, 0.32, and 0.29 has been developed, and the results are very good. It is recommended to use it. Of course, you can continue training by loading it.
